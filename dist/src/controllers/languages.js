...
// @access    Public
exports.languageDetection = asyncHandler((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
// @access    Public
exports.translationLanguagesInEng = asyncHandler((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
// @access    Public
exports.translationLanguages = asyncHandler((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // Lists available translation language with their names in a target language
    const { target } = req.params;
    console.log('exports.translationLanguages -> target', target);
    const [languages] = yield translate.getLanguages(target);
    console.log('Languages:');
    languages.forEach(language => console.log(language));
    if (!languages) {
        return next(new ErrorResponse(`Translation not found with id of ${req.params.id}`, 404));
...
// @access    Public
exports.translationLanguagesSupported = asyncHandler((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    /**
    ...
    try {
        ...
        const [response] = yield translationClient.getSupportedLanguages(request);
